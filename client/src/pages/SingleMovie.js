      ...
      <section id="singlemovie" className="container">
        ...
        <MovieBox />
            ...
            <div className="d-flex justify-content-center p-2 px-2">
              ...
              <button className="btn bg-secondary rounded-3 px-4 py-2 text-dark d-flex align-items-center">
                <AiTwotonePushpin className="text-danger me-2" />
                G-Direct
              </button>
              <button className="btn bg-warning rounded-3 px-4 py-2 text-light d-flex align-items-center">
